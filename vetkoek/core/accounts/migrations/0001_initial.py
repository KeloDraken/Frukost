...
import vetkoek.core.accounts.models
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('username', vetkoek.core.accounts.models.LowercaseCharField(error_messages={'unique': 'This username is not available, please try another one.'}, help_text='Required. 150 characters or fewer. Letters, digits and @/./+/-/_ only.', max_length=300, unique=True, verbose_name='username')),
                ('display_name', models.CharField(blank=True, max_length=100, null=True)),
                ('profile_pic', imagekit.models.fields.ProcessedImageField(blank=True, null=True, upload_to='uploads/accounts/profile_pics/')),
                ...
                ('profile_text_colour', models.CharField(default='#000000', max_length=10)),
                ('profile_bg_colour', models.CharField(default='#ffffff', max_length=10)),
